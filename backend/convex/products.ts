...
export const createProduct = mutation({
  args: {
    ...
    isElectricalDevice: v.optional(v.boolean()),
  ...
  handler: async (ctx, args) => {
    ...
    const productId = await ctx.db.insert("products", {
      ...
      categoryId: args.categoryId, // Add categoryId for proper category tracking
      ...
      isElectricalDevice: args.isElectricalDevice,
      // Champs pour appareils électriques
      coloris: args.coloris,
      natureCheveux: args.natureCheveux,
      actionProduit: args.actionProduit,
      specificites: args.specificites,
      alimentation: args.alimentation,
      poids: args.poids,
      puissance: args.puissance,
      niveauxTemperature: args.niveauxTemperature,
      longueurCable: args.longueurCable,
      fluxAir: args.fluxAir,
      arretAutomatique: args.arretAutomatique,
      accessoiresFournis: args.accessoiresFournis,
      technologie: args.technologie,
      nombreVitesse: args.nombreVitesse,
      moteur: args.moteur,
      zonesSpecifiques: args.zonesSpecifiques,
      origineFabrication: args.origineFabrication,
      createdAt: Date.now(),
    });
