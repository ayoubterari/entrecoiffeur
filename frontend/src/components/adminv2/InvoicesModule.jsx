...
const InvoicesModule = () => {
  ...
  const invoices = useQuery(api.functions.queries.invoices.getAllInvoices);

  // Récupérer les statistiques globales
  const stats = useQuery(api.functions.queries.invoices.getInvoicesStats);

  // Mutation pour générer une facture depuis une commande
  const generateInvoice = useMutation(api.functions.mutations.invoices.generateInvoiceFromOrder);
  ...
  const filteredInvoices = invoices?.filter(invoice => {
    const matchesSearch = 
      ...
      `${invoice.seller.firstName} ${invoice.seller.lastName}`.toLowerCase().includes(searchTerm.toLowerCase());
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Factures conformes aux normes françaises - Vue d'ensemble de la plateforme
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-yellow-600">
              {stats.issuedInvoices + stats.sentInvoices}
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{stats.totalTVA.toFixed(2)} €</div>
        ...
        <CardContent>
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1 relative">
              ...
              <Input
                placeholder="Rechercher par numéro, commande, client ou vendeur..."
                value={searchTerm}
